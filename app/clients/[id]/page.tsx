...
export default function EditClientPage() {
  ...
  const { policyFiles, clients, updateClient } = useAppStore()
  ...
  useEffect(() => {
    if (client) {
      ...
      setLogo(client.logo)
      setHeaderText(client.headerText)
      setFooterCenterText(client.footerCenterText)
      setSelectedPolicies(client.selectedPolicies)
    }
  }, [client])
        ...
        <div className="max-w-4xl mx-auto">
          <header className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">
              Update client branding and document preferences
            </p>
          </header>
